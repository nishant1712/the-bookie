...
import com.example.findmystuff.adapter.NavDrawerListAdapter;
import com.example.findmystuff.model.NavDrawerItem;
...
public class Profile extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.profiledrawer);
	...
	public void setTitle(CharSequence title) {
		mTitle = title;
		getActionBar().setTitle("FindMyStuff");
	}
